                    ...
                    <form role="form" action="" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="nrphone" name="senha" placeholder="Digite sua senha">
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="tipo_usuario" value="1"> Acesso de Administrador
                                </label>
                            </div>
                        </div>
                        <!-- /.box-body -->
